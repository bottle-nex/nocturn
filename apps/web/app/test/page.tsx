    ...
    return (
        <div className="bg-white dark:bg-zinc-900 w-full h-full rounded-sm px-12 py-10">
            ...
            <section className="flex items-center justify-start gap-x-3 mt-10">
                ...
                <Button
                    variant={'outline'}
                    className="rounded-full w-36 bg-gray-500/10 dark:bg-gray-500/10 hover:dark:bg-gray-500/20 hover:bg-gray-500/20 border-neutral-700 dark:border-neutral-600 text-black dark:text-white active:scale-98"
                >
