            ...
            {showBanner && (
                <section className="bg-alpha min-h-16 flex items-center justify-end w-full px-12">
                    <div className="flex items-center gap-x-3 pr-4">
                        <span className="text-light-alpha text-sm">
                                ...
                                <span>
                                    <section className="w-full max-w-82 px-3 py-4 space-y-2">
                                        ...
                                        <p className="text-sm w-full dark:text-dark-base/70 text-light-base/70">
                                            On Free, you can present to 50 participants each month.
                                            If more people join a live presentation and this limit
                                            is exceeded, you won&apos;t be interrupted. You have
                                            presented to 0/50 participants this month. This resets
                                            on March 20th.
                                        </p>
