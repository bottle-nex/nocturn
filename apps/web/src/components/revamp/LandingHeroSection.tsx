...
export default function LandingHeroSection() {
    ...
    repeating-linear-gradient(
      ...
      `,
            ...
            >
                <div className='bg-clip-text text-transparent bg-linear-to-b dark:from-light-alpha dark:via-light-base dark:to-light-alpha/40 from-dark-alpha via-dark-base to-dark-alpha/70 dark:text-shadow-2xs'>The only quizzing platform</div>
                <div className='bg-clip-text text-transparent bg-linear-to-b dark:from-light-alpha dark:via-light-base dark:to-light-alpha/40 from-dark-alpha via-dark-base to-dark-alpha/70 dark:text-shadow-2xs'>where knowledge pays</div>
            </motion.div>
