                ...
                <div className="text-light-alpha text-8xl leading-[1.04] font-black w-full flex flex-col items-center">
                    <section className='flex items-center gap-x-3'>
                        ...
                        <motion.span
                            ...
                            <motion.img transition={{ delay: 0.6, duration: 0.2, ease: "easeOut" }} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className='object-contain absolute inset-0 w-full h-full' alt='illus' src={"/illustrations/avatar.png"} />
                        </motion.span>
