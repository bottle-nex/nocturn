    ...
    return (
        <main>
            ...
            <section className="w-full grid grid-cols-[1fr_2fr] gap-x-8 mx-auto max-w-270 mt-16">
                ...
                <div className="">
                    <div className="w-full flex items-center justify-between">
                        <AnimatedHeading className="text-3xl text-black">Rishi Kant (Founder and Ceo)</AnimatedHeading>
            ...
            <section className="w-full grid grid-cols-[2fr_1fr] gap-x-8 mx-auto max-w-270 mt-24">
                <div className="">
                    <div className="w-full flex items-center justify-between">
                        <AnimatedHeading className="text-3xl text-black">Anjan Suman (Co-Founder)</AnimatedHeading>
                        <div className="inline-flex space-x-2">
            ...
            <section className="w-full grid grid-cols-[1fr_2fr] gap-x-8 mx-auto max-w-270 mt-24">
                ...
                <div className="">
                    <div className="w-full flex items-center justify-between">
                        <AnimatedHeading className="text-3xl text-black">Piyush Raj (Co-Founder)</AnimatedHeading>
                        <div className="inline-flex space-x-2">
