...
export default function DifficultyCard() {
    return (
        <div className="h-65 w-65 ring-1 ring-black/10 rounded-xl flex flex-col overflow-hidden shadow-sm shadow-black/10 absolute rotate-6 bg-[#f9fcff] right-[22%] top-40 select-none">
