  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "bg-foreground text-background border-2 border-black font-heading shadow-shadow rounded-sm text-[13px] flex items-center gap-2.5 p-4 w-[356px] [&:has(button)]:justify-between",
