    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-2 -mt-32">
                <p className="dark:text-gamma text-dark-alpha font-semibold text-xl sm:text-2xl">
                    {title}
                </p>
                {description && (
                    <p className="dark:text-gamma/50 text-dark-base/80 text-sm sm:text-base max-w-xs sm:max-w-sm">
                        {description}
                    </p>
                )}
            </div>
