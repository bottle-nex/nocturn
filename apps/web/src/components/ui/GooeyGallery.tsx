...
const cards = [
    {
        ...
        skeleton: (
            <div className="h-48 w-full rounded-xl relative">
                <Image
    ...
    return (
        <section className="max-w-270 mx-auto w-full">
            ...
            <motion.div ref={ref} className="w-full h-160 relative mt-40">
                {cards.map((card) => (
                    <motion.div
                        className="shadow-[0_35px_70px_rgba(0,73,138,0.2)]"
                        key={card.title}
                    >
                        <motion.button
                            initial={{
                        ...
                        >
                            ...
                            <div>
                                <motion.h2
                                    ...
                                    className="font-signika max-w-40 text-3xl text-left font-regular "
                                >
                                    {card.title}
                                </motion.h2>
