...
function LightAppLogo({ size, className }: AppLogoProps) {
    return (
        <div
            className={`dark:hidden bg-dark-base p-1.5 rounded-sm border border-dark-alpha flex justify-center items-center `}
            style={{
                height: size,
                width: size,
            }}
...
function DarkAppLogo({ size, className }: AppLogoProps) {
    return (
        <div
            className={`hidden dark:flex dark:bg-light-base p-1.5 rounded-sm border border-dark-alpha justify-center items-center `}
            style={{
                height: size,
                width: size,
            }}
