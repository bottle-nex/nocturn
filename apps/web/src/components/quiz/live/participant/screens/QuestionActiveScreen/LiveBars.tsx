...
export function LiveResponseBars({
    ...
    const { currentQuestion, quiz, gameSession, liveResponses, getLiveResponsePercentages } =
        useLiveQuizStore();
        ...
        >
            ...
            <div className="flex items-center gap-1 mb-3 text-gray-300">
                ...
                <span className={cn('font-medium', config.text)}>
                    {liveResponses.totalResponses} response
                    {liveResponses.totalResponses !== 1 ? 's' : ''}
                </span>
            </div>
                        ...
                        <div key={idx} className="space-y-1">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2 text-gray-300">
                                    <span className={cn('font-mono', config.text)}>{count}</span>
                                    {showPercentages && (
                                        <span
                                            className={cn(
                                                'font-mono min-w-[3rem] text-right',
                                                config.text,
                                            )}
                                        >
                                            {percentage}%
