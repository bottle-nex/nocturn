        ...
        <div className="flex flex-col h-full justify-between relative z-[200]">
                    ...
                    {enableNameChange && !participantData?.isNameChanged && (
                        <form onSubmit={handleSubmit} className="flex flex-col space-y-2 mt-4">
                            ...
                            <Input
                                ...
                                className="py-5 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none dark:text-light-base text-dark-alpha"
                            />
                        </form>
                    )}
                </div>
            ...
            <div className="flex justify-between items-center px-7 py-4 border-t">
                <div className="flex items-center gap-x-3">
                    ...
                    <span className="text-sm dark:text-light-base text-dark-alpha">
                        {participantData?.nickname}
                    </span>
                </div>
                <IoMdSettings
                    size={24}
                    className="cursor-pointer text-dark-alpha dark:text-light-base"
                />
            </div>
        </div>
    );
