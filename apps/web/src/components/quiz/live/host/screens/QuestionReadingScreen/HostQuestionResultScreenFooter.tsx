...
export default function HostQuestionResultScreenFooter() {
    ...
    return (
        <div className="absolute bottom-4 left-4 z-100 flex items-center justify-start gap-x-4 w-fit">
            <Button
                className="dark:bg-dark-base dark:text-neutral-100 bg-neutral-300 text-tprime dark:hover:-translate-y-0.5 z-20 cursor-pointer bg-red-500! hover:bg-red-500!"
