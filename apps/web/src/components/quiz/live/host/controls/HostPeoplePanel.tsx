                ...
                <div className="grid grid-cols-2 gap-3 dark:bg-neutral-800 backdrop-blur-md rounded-xl border shadow-md">
                    {Object.values(PeopleViewType).map((tab) => (
                        <Button
                            ...
                            onClick={() => setView(tab)}
                            className={cn(
                                'px-4 py-2 rounded-xl text-xs font-medium transition-all bg-transparent dark:bg-transparent col-span-1 lowercase  cursor-pointer bg-red-500! hover:bg-red-500!',
                                {
