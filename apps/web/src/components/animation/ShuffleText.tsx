        ...
        () => {
            ...
            const teardown = () => {
                ...
                try {
                    ...
                    // GSAPSplitText.revert() can throw if DOM was already cleaned up
                    console.error('Error reverting GSAPSplitText:', e);
                }
            ...
            const build = () => {
                ...
                chars.forEach((ch) => {
                    ...
                    const isVerticalDir = shuffleDirection === 'up' || shuffleDirection === 'down';

                    const wrap = document.createElement('span');
                    wrap.className = 'inline-block text-left';
                    Object.assign(wrap.style, {
                        width: w + 'px',
                        height: isVerticalDir ? h + 'px' : 'auto',
                        verticalAlign: 'bottom',
                        // Use clip-path so vertical shuffle clips top/bottom but never clips left/right (italic overhang)
                        clipPath: isVerticalDir
                            ? 'inset(0 -100% 0 -100%)'
                            : 'inset(-100% 0 -100% 0)',
                    });
