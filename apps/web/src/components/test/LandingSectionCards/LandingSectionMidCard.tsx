    ...
    return (
        ...
        >
            <div className="h-50 w-full relative">
                <div className="absolute h-12 w-41 bg-[#f8f8f8] dark:bg-dark-alpha rounded-xl ring-1 ring-black/5 dark:ring-white/2 shadow-xs shadow-black/10 top-2 right-0 z-2 flex gap-x-1 items-center px-3 rotate-3 group-hover:blur-[1px] transition-all transform duration-200">
                    <div className="relative h-8 w-8 rounded-full overflow-hidden shrink-0 ring-1 ring-green-500 shadow-xs shadow-black/5 flex justify-center items-center bg-green-100/60 dark:bg-green-300/20 ">
                        <PiMoneyWavyLight className="text-green-600 size-5.5 stroke-2" />
                    </div>
                    <div className="w-full h-8 flex flex-col pl-1.5 justify-between">
                        <div className="text-xs text-dark-base/60 dark:text-light-base/60 ">
                            Connect Wallet
                        </div>
                        <div className="text-dark-base/90 dark:text-light-base/90 text-[11px] leading-3 pb-0.5">
                            Add money in game
                        </div>
                    </div>
                </div>
                ...
                <div className="absolute h-16 w-48 bg-[#f8f8f8] dark:bg-dark-alpha rounded-xl ring-1 ring-black/5 dark:ring-white/2 shadow-xs shadow-black/10 top-13 left-3 flex gap-x-1 items-center px-3 -rotate-3 z-3 group-hover:scale-105 group-hover:rotate-1 transition-all transform duration-250">
                    ...
                    <div className="w-full h-11 flex flex-col justify-between pl-1">
                        ...
                        <div className="text-dark-base/90 dark:text-light-base/90 text-[11px] leading-3">
                            Added modern theme and base points per Q
                        </div>
                    </div>
                </div>

                <div className="absolute h-12 w-44 bg-[#f8f8f8] dark:bg-dark-alpha rounded-xl ring-1 ring-black/5 dark:ring-white/2 shadow-xs shadow-black/10 bottom-3 right-8 z-0 flex gap-x-1 items-center px-3 rotate-3 group-hover:blur-[1px] transition-all transform duration-200">
                    <div className="relative h-8 w-8 rounded-full overflow-hidden shrink-0 ring-1 ring-amber-500 shadow-xs shadow-black/5 flex justify-center items-center bg-amber-100/60 dark:bg-amber-300/20">
