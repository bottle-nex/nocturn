...
export default function LandingSectionLeftCard() {
    ...
    return (
        <motion.div
            ...
            className="h-80 w-78 rounded-4xl ring-4 ring-white bg-linear-to-b from-neutral-300/50 via-neutral-200/50 to-neutral-100/50 shadow-xl absolute top-4 left-[11%] p-6 flex flex-col justify-between overflow-hidden scale-115"
        >
