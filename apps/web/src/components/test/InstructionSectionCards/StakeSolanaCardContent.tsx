...
export default function StakeSolanaCardContent(): JSX.Element {
    return (
        <div className="w-60 h-60 ring-1 ring-black/10 dark:ring-white/10 shadow-xs shadow-black/5 rounded-2xl bg-light-alpha dark:bg-dark-alpha shrink-0 relative group overflow-hidden">
            <div className="group relative absolute h-15 w-15 bg-light-base dark:bg-dark-base ring-2 ring-light-alpha dark:ring-dark-alpha shadow-md shadow-black/10 rounded-xl z-10 top-30 left-1/2 -translate-x-1/2 flex justify-center items-center group-hover:-translate-y-1 transition-all transform duration-250 ease-in-out ">
            ...
            <div className="absolute h-70 w-40 ring-8 ring-dark-base/90 top-15 left-1/2 -translate-x-1/2 rounded-3xl flex flex-col py-1.5 px-2.75 group-hover:-translate-y-1 transition-all transform duration-250 ease-in-out shadow-xl shadow-neutral-600">
                <div className="bg-light-base dark:bg-dark-base mt-5 h-full w-full absolute left-0 rounded-t-2xl"></div>
                ...
                <div className="w-full text-dark-base dark:text-light-base flex justify-between items-center text-[9px]">
