...
export default function WhyNocturnCard1() {
    return (
        <div className="h-[65vh] w-full max-w-110 shadow-xs shadow-black/5 rounded-4xl bg-[#f2f1f3] flex flex-col py-15 px-12 gap-y-2 relative overflow-hidden">
            ...
            <div className="text-dark-faded text-[15px] font-extralight tracking-wide">
                Our stake-based quiz platform transforms learning into a competitive and rewarding
