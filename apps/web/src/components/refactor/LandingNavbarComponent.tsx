...
export default function LandingNavbarComponent() {
    ...
    return (
        <motion.div
            ...
            className={`w-full max-w-270 mx-auto fixed inset-x-0 top-0 flex items-center justify-between z-30 px-6 xl:px-0 backdrop-blur-lg transition-colors duration-300 ${atTop ? 'bg-white/70' : 'bg-white/85 border-b border-px border-dark-alpha/7 shadow-xs shadow-black/[0.02]'}`}
        >
