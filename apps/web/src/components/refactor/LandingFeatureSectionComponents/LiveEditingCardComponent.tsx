...
export default function LiveEditingCardComponent() {
    ...
    return (
        <div className="flex flex-col ring-1 ring-black/10 h-auto sm:h-75 w-full max-w-[440px] rounded-xl overflow-hidden">
            <div className="h-55 bg-charlie relative flex justify-center pt-7 shrink-0">
                <div className="absolute bottom-12 right-31 z-2 -rotate-90">
                    <FaLocationArrow className="text-light-alpha" />
                </div>
                <div className="absolute bottom-6 right-10 h-7 w-22 bg-dark-alpha z-2 flex items-center justify-center text-sm text-light-base rounded-full">
                    Red John
                </div>
                <div className="h-45 w-70 shadow-xs shadow-black/5 bg-linear-to-b from-light-alpha via-light-alpha/80 to-charlie rounded-t-xl absolute bottom-0 left-1/2 -translate-x-1/2 flex flex-col py-3">
