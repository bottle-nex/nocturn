...
export default function LandingPublishCardComponent() {
    return (
        <div className="relative w-full h-100 rounded-lg bg-light-alpha ring-1 ring-black/10 shadow-xs shadow-black/5 overflow-hidden p-6">
            ...
            <div className="absolute h-70 w-80 rounded-2xl ring-1 ring-black/10 -bottom-5 -right-20" />
            <div className="absolute h-70 w-80 rounded-2xl ring-1 ring-black/10 -bottom-8 -right-15 z-10 bg-light-alpha" />

            <div className="absolute h-70 w-80 rounded-2xl ring-1 ring-black/10 -bottom-11 -right-10 z-20 bg-light-base overflow-hidden">
