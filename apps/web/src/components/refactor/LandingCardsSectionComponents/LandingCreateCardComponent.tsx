...
export default function LandingCreateCardComponent() {
    return (
        <PerspectiveCard className="relative mt-20 w-full max-w-85 xs:max-w-full h-100 rounded-xl bg-linear-to-br from-[#6558f5] to-[#352b9e] ring-1 ring-black/10 shadow-xs shadow-black/5 overflow-hidden p-6">
            <LandingCardHeader
                title="Create quiz"
