...
export default function ParticipantUserCard() {
    return (
        <PerspectiveCard className="relative w-full h-80 bg-linear-to-br from-[#1aa89f] to-[#0b433f] rounded-2xl flex flex-col overflow-hidden group shadow-sm">
            <motion.div
                animate={{
            ...
            >
                <div className="w-70 bg-teal-950" />
                <div className="h-40 w-40 rounded-full -ml-20 bg-teal-200/80 flex overflow-hidden">
                    <div className="w-full h-full" />
                    <div className="w-full h-full bg-teal-950" />
                </div>
            </motion.div>
