...
export default function NavResourcesDropdown({
    ...
    return (
        ...
        >
            <div
                className="relative w-75 bg-dark-base rounded-xl p-1.75 overflow-hidden"
                style={{
                    ...
                    <AnimatePresence>
                        {hoveredIdx !== null && (
                            <motion.div
                                ...
                                className="absolute left-0 w-full bg-dark-faded rounded-[10px] pointer-events-none"
                                initial={{
                                    top: bgStyle.top,
                        ...
                        return (
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        backgroundColor: isHovered ? item.bgColor : '#242a2a',
                                ...
                                <div className="flex flex-col gap-0.5 min-w-0">
                                    <span className="text-[14px] font-semibold text-light-base/90 tracking-[-0.01em] leading-tight">
                                        {item.title}
                                    </span>
                                    <span className="text-[12.5px] text-light-base/45 leading-snug">
                                        {item.description}
                                    </span>
                                </div>
                            </div>
