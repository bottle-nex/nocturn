    ...
    return (
        <div
            className={cn(
                ...
                'file:text-foreground placeholder:text-muted-foreground selection:bg-alpha selection:text-alpha-foreground border-none flex w-full min-w-0 rounded-md border px-4 py-2.5 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
