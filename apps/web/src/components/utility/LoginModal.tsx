        ...
        <div>
            {opensignInModal && (
                <OpacityBackground onBackgroundClick={() => setOpenSignInModal(false)}>
                    <UtilityCard className="max-w-md px-8 py-6 flex flex-col items-center justify-center space-y-6 z-50 rounded-md">
                        ...
                        <Button
                            ...
                            className="w-full flex items-center justify-center gap-3 px-6 py-[22px] text-sm font-medium bg-neutral-200 hover:bg-neutral-200/70 dark:bg-dark-alpha/30 hover:dark:bg-dark-alpha/40 rounded-md border-[1px] border-neutral-300 dark:border-neutral-700 cursor-pointer"
                        >
                            <Image
                        ...
                        <Button
                            ...
                            className="w-full flex items-center justify-center gap-3 px-6 py-[22px] text-sm font-medium bg-neutral-200 hover:bg-neutral-200/70 dark:bg-dark-alpha/30 hover:dark:bg-dark-alpha/40 rounded-md border-[1px] border-neutral-300 dark:border-neutral-700 cursor-pointer"
                        >
                            <FaGithub className="dark:text-light-base text-dark-alpha text-[28px]" />
