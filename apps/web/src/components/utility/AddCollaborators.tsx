...
export default function AddCollaborators({ open, setOpen }: AddCollaboratorsProps): JSX.Element {
    ...
    return (
        <UtilityCard
            ...
            className="w-100 py-5 absolute top-full right-0 translate-y-2 dark:bg-dark-base bg-neutral-100 rounded-sm dark:border-neutral-800/40! border-neutral-300/40 overflow-hidden"
        >
