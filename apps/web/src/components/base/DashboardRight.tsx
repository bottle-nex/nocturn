...
export default function DashboardRight(): JSX.Element {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 dark:bg-dark-primary/90 bg-neutral-200 border-l-[1px] border-t-[1px] dark:border-neutral-800 border-neutral-300 rounded-tl-xl min-h-0 overflow-hidden">
                {renderDashboard()}
            </div>
        </motion.div>
    );
