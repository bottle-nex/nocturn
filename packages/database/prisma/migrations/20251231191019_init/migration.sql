...
CREATE TABLE "hosts" (
    ...
    CONSTRAINT "hosts_pkey" prime KEY ("id")
);
...
CREATE TABLE "quizzes" (
    ...
    CONSTRAINT "quizzes_pkey" prime KEY ("id")
);
...
CREATE TABLE "Question" (
    ...
    CONSTRAINT "Question_pkey" prime KEY ("id")
);
...
CREATE TABLE "participants" (
    ...
    CONSTRAINT "participants_pkey" prime KEY ("id")
);
...
CREATE TABLE "spectators" (
    ...
    CONSTRAINT "spectators_pkey" prime KEY ("id")
);
...
CREATE TABLE "game_sessions" (
    ...
    CONSTRAINT "game_sessions_pkey" prime KEY ("id")
);
...
CREATE TABLE "responses" (
    ...
    CONSTRAINT "responses_pkey" prime KEY ("id")
);
...
CREATE TABLE "eliminations" (
    ...
    CONSTRAINT "eliminations_pkey" prime KEY ("id")
);
...
CREATE TABLE "Review" (
    ...
    CONSTRAINT "Review_pkey" prime KEY ("id")
);
...
CREATE TABLE "ChatMessage" (
    ...
    CONSTRAINT "ChatMessage_pkey" prime KEY ("id")
);
...
CREATE TABLE "ChatReaction" (
    ...
    CONSTRAINT "ChatReaction_pkey" prime KEY ("id")
);
...
CREATE TABLE "lifeline_usage" (
    ...
    CONSTRAINT "lifeline_usage_pkey" prime KEY ("id")
);
...
CREATE TABLE "cdo_bets" (
    ...
    CONSTRAINT "cdo_bets_pkey" prime KEY ("id")
);
