...
export enum MESSAGE_TYPES {
  ...
  ADVANCE_QUIZ_END_SCREEN = "HOST_ADVANCE_QUIZ_END_SCREEN",
  ...
  PARTICIPANT_INDIVIDUAL_RANK = "PARTICIPANT_INDIVIDUAL_RANK",
  ...
  PRIZE_CLAIMS_READY = "PRIZE_CLAIMS_READY",
  PRIZE_FINALIZATION_UPDATE = "PRIZE_FINALIZATION_UPDATE",
}
